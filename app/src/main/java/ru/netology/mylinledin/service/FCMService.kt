package ru.netology.mylinledin.service
...
class FCMService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        if( value.recipientId == null || value.recipientId == appAuth.authStateFlow.value.id){
            ...
            println(str)}
        if (value.recipientId != 0 && value.recipientId !=appAuth.authStateFlow.value.id && value.recipientId != null) {
            //appAuth.uploadPushToken()
        } else if (value.recipientId == 0 && value.recipientId !=appAuth.authStateFlow.value.id && value.recipientId != null) {
           // appAuth.uploadPushToken()
        }
